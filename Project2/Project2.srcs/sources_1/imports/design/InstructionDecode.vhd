...
-- UNCOMMENT THE LINES CORRESPONDING TO YOUR OPCODES
  ...
  --------------------------------------------------------------------------------------------------------------------------------  
    0 =>  '0' &   x"0"  &  x"0"   &  x"0"   &  "0000"   &  "000"  &  "00"  &  "00"  &  "00"  & "00"  &  '0' &  "00",  -- ADD    R[DR],R[SA],R[SB]
--          0 =>  '?' &   x"?"  &  x"?"   &  x"?"   &  x"?"   &  "???"  &  "??"  &  "??"  &  "??"  & "??"  &  '?' &  "??",  -- ADDI   R[DR],R[SA],SIMM18
    2 =>  '0' &   x"0"  &  x"0"   &  x"0"   &  "0011"   &  "000"  &  "00"  &  "00"  &  "00"  & "00"  &  '0' &  "00",  -- SUB    R[DR],R[SA],R[SB]
    3 =>  '0' &   x"0"  &  x"0"   &  x"0"   &  "0011"   &  "001"  &  "00"  &  "01"  &  "00"  & "00"  &  '0' &  "00",  -- SUBI   R[DR],R[SA],SIMM18
  --------------------------------------------------------------------------------------------------------------------------------  
  -- OPCODE =>  PL  &  dAA    & dBA     & dDA     &  FS     &  KNSSel &  MASel &  MBSel &  MMA   & MMB   &  MW  &  MDSel
  --------------------------------------------------------------------------------------------------------------------------------  
...
--          0 =>  '?' &   x"?"  &  x"?"   &  x"?"   &  x"?"   &  "???"  &  "??"  &  "??"  &  "??"  & "??"  &  '?' &  "??",  -- LSR    R[DR],R[SB]
    16 =>  '0' &   x"0"  &  x"0"   &  x"0"   &  "1110"   &  "000"  &  "00"  &  "00"  &  "00"  & "00"  &  '0' &  "00",   -- ROL       R[DR],R[SB]
...
--          0 =>  '?' &   x"?"  &  x"?"   &  x"?"   &  x"?"   &  "???"  &  "??"  &  "??"  &  "??"  & "??"  &  '?' &  "??",  -- ST     (R[AA]+SIMM18),R[SB]
  ...
  -- OPCODE =>  PL  &  dAA    & dBA     & dDA     &  FS     &  KNSSel &  MASel &  MBSel &  MMA   & MMB   &  MW  &  MDSel
  --------------------------------------------------------------------------------------------------------------------------------  
    23 =>  '1' &   x"0"  &  x"0"   &  x"0"   &  "0011"   &  "011"  &  "00"  &  "00"  &  "00"  & "00"  &  '0' &  "10",  -- B.cond  (R[SA] cond R[SB]),SIMM14
