...
HD_PWD='C:/Users/Maria/Desktop/lab52/lab52.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sd.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sd.tcl -notrace
